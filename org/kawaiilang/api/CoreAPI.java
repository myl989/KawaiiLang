...
public class CoreAPI {
  ...
  static class Pop extends BuiltInFunction {
	static final LinkedHashMap<String, String> parameters = new LinkedHashMap<>();
	static {
	  parameters.put("a", "Lwist");
	  parameters.put("b", "Numwer");
	}
  ...
  //TEMPLATE CLASSES FOR BUILT-IN FUNCTIONS
  
  /*
  static class Template extends BuiltInFunction {
	private Template(KawaiiLangRuntime interpreter) {
  ...
  static class TemplateWithInputs extends BuiltInFunction {
	...
	private TemplateWithInputs(KawaiiLangRuntime interpreter) {
	  super(interpreter, "API name", "senpaiStawp", parameters, return value);
	}
