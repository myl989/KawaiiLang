...
public class Token {
  ...
  public static final String[] KEYWORDS = {"cwass", "waifu", "husbando", "cwassType", "waifuType", "husbandoType", "hasSensi", "imaginawy", "OwO", "notices", "^_^ewndNotice", "^_^ewndCwass", "^_^ewndWaifu", "^_^endHusbando", "canDo", "gibU", "canGibU", "ewlse", "bweak", "^_^letsStawt", "pwbwic", "pwotected", "pwiwate", "awnd", "orw", "nawt", "xwr", "eqwals", "dewete"};
